...
/**
 * Created by :- Mukesh Kumawat on 25-Oct-16.
...
import com.parasme.swopinfo.helper.CustomList;
import com.parasme.swopinfo.helper.CustomListSingleOnly;
...
public class FileSelectionActivity extends Activity {
    ...
    public void ok(){
        ...
        Log.e(TAG, "Files: "+resultFileList.toString());

        mFilePicker.onFilesSelected(resultFileList);

        // Code to set result to activity
/*
...
*/
    ...
    public  interface FilePicker{
        void onFilesSelected(ArrayList<File> resultFileList);
    }

    public static void setOnFilePickListener(FilePicker filePicker){
