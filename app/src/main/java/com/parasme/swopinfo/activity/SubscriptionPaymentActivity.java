...
public class SubscriptionPaymentActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void loadCountryDialog() {
        ...
        countryNameList= new Utils(SubscriptionPaymentActivity.this).getCountryNames();

        Object[] objects=new Utils(SubscriptionPaymentActivity.this).loadCountryDialog(countryNameList);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.editDOB:
                new Utils(SubscriptionPaymentActivity.this).selectDate(editDOB);
                break;
            case R.id.btnReadMore:
                MyApplication.alertDialog(SubscriptionPaymentActivity.this,getResources().getString(R.string.subscription_description),"Business Account");
                break;
    ...
    private void register(String email, String fname, String lname, String username, String dob, String country, String password,
        ...
        WebServiceHandler webServiceHandler = new WebServiceHandler(SubscriptionPaymentActivity.this);
                    ...
                    public void run() {
                        try{
                            ...
                            if(jsonObject.opt("returnvalue") instanceof JSONObject){
                                ...
                                MyApplication.alertDialog(SubscriptionPaymentActivity.this,"Could not process the request","Register Unsuccessful");
                        }
    ...
    private void chargePayPal(String chargeAmount) {
        ...
        Intent intent = new Intent(SubscriptionPaymentActivity.this, PaymentActivity.class);
                    ...
                    public void run() {
                        try{
                            ...
                            if(jsonObject.optString("status").equals("200"))
                                MyApplication.alertDialog(SubscriptionPaymentActivity.this,"Verify mail is sent to your email id","Alert");
                            else
                                MyApplication.alertDialog(SubscriptionPaymentActivity.this,"Could not activate the company profile","Company Activation");
