package com.parasme.swopinfo.helper.routemap;

/**
 * Created by mukesh on 13/11/17.
 */
...
import com.parasme.swopinfo.fragment.FragmentMap;
...
public class RouteDrawerTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
    ...
    protected List<List<HashMap<String, String>>> doInBackground(String... jsonData) {
        ...
        try {
            ...
            Log.e("RouteDrawerTask", jsonData[0]);
    ...
    protected void onPostExecute(List<List<HashMap<String, String>>> result) {
        if (result != null)
            ...
            Log.e("RouteDrawerTask","could not draw");
    }
    ...
    private void drawPolyLine(List<List<HashMap<String, String>>> result) {
        ...
        if (lineOptions != null && mMap != null) {
            ...
            MyApplication.alertDialog(FragmentMap.appCompatActivity, "No route found between locations","Route");
            Log.e("onPostExecute", "without Polylines draw");
        }
    }
